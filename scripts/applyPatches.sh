...
export GIT_AUTHOR_NAME="${GIT_AUTHOR_NAME:-MindustryX CI}"
export GIT_AUTHOR_EMAIL="${GIT_AUTHOR_EMAIL:-ci@noreply.example.com}"
export GIT_COMMITTER_NAME="${GIT_COMMITTER_NAME:-MindustryX CI}"
export GIT_COMMITTER_EMAIL="${GIT_COMMITTER_EMAIL:-ci@noreply.example.com}"
